    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content" class="bg-gray-200">
            ...
            <div class="container-fluid">
                ...
                <!-- Empieza FOR-EAH-->
                <c:forEach items="${encargados_devolucion}" var="encargado">
                    <div class="col-md-12">
                        <div class="card card-shadow border-0 mb-4">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center">
                                    <h5 class="font-weight-medium mb-0">Rol: ENCARGADO DE DEVOLUCION</h5>
                                </div>
                                <div class="col">
                                    <div class="col-lg-12">
                                        <div class="row mt-3">
                                            <div class="col-lg-6 align-self-center">
                                                <ul class="list-inline pl-3 font-16 font-weight-medium text-dark mt-3">
                                                    <li class="py-2"><i class="icon-check text-info mr-2"></i>
                                                        Nombre: <span>${encargado.nombre}</span>
                                                    </li>
                                                    <li class="py-2"><i class="icon-check text-info mr-2"></i>
                                                        Mail: <span>${encargado.email}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
