...
INSERT INTO usuario (clave, email, rol, nombre) VALUES ('clave', 'mail@mail', 'cliente', 'Sheni'), ('clave', 'mail@enca', 'encargado', 'Jonni'), ('clave', 'mail@enca2', 'encargado', 'Alan');
INSERT INTO garage (id, cantAutosActual, capacidad, direccion, encargado_id) VALUES (1, 36, 85, 'Av. de Mayo 2525', 2), (2, 26, 40, '9 de Julio 922', 3);
